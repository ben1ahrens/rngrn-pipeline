...
# here is largely a small-box artefact rather than a distinct pattern type. Only the very
# bottom of the canonical range p = 8..40 overlaps the regime where stripes has ever
# occurred at all, and no candidate survives the stability probe regardless.
